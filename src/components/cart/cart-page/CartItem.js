...
const CartItem = ( {
	...
	const handleQtyChange = (event, cartKey) => {
		if (typeof window !== "undefined") { // Обновленная проверка
			...
			// If the user tries to delete the count of product, set that to 1 by default (This will not allow it to be reduced below zero)
